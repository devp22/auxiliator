...
class DeleteHelper extends StatefulWidget {
  const DeleteHelper({Key? key}) : super(key: key);

  @override
  State<DeleteHelper> createState() => _DeleteHelperState();
}

class _DeleteHelperState extends State<DeleteHelper> {
